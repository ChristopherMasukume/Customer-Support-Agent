...
system_prompt = """
You are a helpful customer support AI agent for an e-commerce platform.
Help customers track orders, process returns and refunds, answer product and
policy questions using the knowledge base, calculate loyalty discounts, and
...
app = BedrockAgentCoreApp()  # Replaced this line with the actual instantiation of the app so that the app can initialize.
...
GATEWAY_URL = "https://customersupportgateway-9jrzryhf6m.gateway.bedrock-agentcore.us-east-1.amazonaws.com/mcp"   # TODO: Replace with your Gateway URL
KB_ID       = "KQWCMCKDGR"          # TODO: Replaced with your Knowledge Base ID on my aws student account
REGION      = "us-east-1"        # TODO: Replaced with your AWS region
MEMORY_ID   = "CustomerSupportMemory-O7M3yyHETY"        # TODO: Replaced with your Memory ID
...
def get_namespaces(mem_client: MemoryClient, memory_id: str) -> Dict:
    ...
    # TODO: Implement this function (function body has been replaced with the actual implementation)
...
class MemoryHook(HookProvider):
    ...
    def retrieve_customer_context(self, event: MessageAddedEvent):
        ...
        # Only process plain-text messages, not tool results
        ...
        query = "".join(block["text"] for block in content).strip()
...
def search_knowledge_base(query: str) -> str:
    ...
    # Guard: make sure the Knowledge Base is configured
    if not KB_ID:
    ...
    return "\n\n".join(chunks)# Guard: make sure the Knowledge Base is configured
...
async def invoke(payload, context=None):
    ...
    try:
        ...
        # 2. Create the memory hook for this customer/session
